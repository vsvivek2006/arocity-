...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Having stayed at luxury hotels across the globe, I demand uncompromising standards. The Russian escort who arrived at my suite within 30 minutes was genuine, statuesque, and captivating. The zero-advance policy gave me complete confidence.',
  },
  {
    name: 'Siddharth R.',
    location: 'DLF Phase 5 (The Camellias)',
    rating: 5,
    text: 'The discretion and attention to detail from ALINA VIP are unmatched in Delhi NCR. From the rapid concierge WhatsApp support to the escort’s radiant charm and poise, everything was handled with executive elegance.',
  },
  {
    name: 'Sameer N.',
    location: 'Aerocity Hospitality District',
    rating: 5,
    text: 'Booked an air hostess escort during a brief transit layover in Aerocity. Punctual, beautifully groomed, and an absolute pleasure to converse with. Easily the most reliable escort agency in Gurgaon and Delhi.',
  },
  {
    name: 'Anish T.',
    location: 'Sohna Road, Gurgaon',
    rating: 5,
    text: 'I was hesitant about agency bookings, but ALINA VIP put all concerns to rest. The independent escort was verified in-person, warm, affectionate, and completely unhurried. Highly recommended for discerning gentlemen.',
  },
  {
    name: 'Rohan P.',
...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Experience Gurgaon’s vibrant nightlife with a gorgeous, fun-loving partner. From exclusive rooftop lounges in Sector 29 to private farmhouse pool parties, our VIP escorts bring joyful energy, dazzling smiles, and sophisticated revelry.',
    icon: 'PartyPopper',
  },
  {
    ...
    description: 'Tailored for senior executives, business tycoons, and visiting multinational directors. Our corporate escorts possess university backgrounds, sharp intellect, and flawless English fluency, making them ideal partners for business dinners and corporate retreats.',
    icon: 'Briefcase',
  },
  {
