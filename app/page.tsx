...
export default function HomePage() {
  const organizationSchema = {
    ...
    alternateName: [
      'Aerocity Escort Service Escorts Service Gurgaon',
      'Aerocity Escort Service Escort Service Gurugram',
    ],
    url: siteConfig.url,
  ...
  const localBusinessSchema = {
    ...
    '@type': 'LocalBusiness',
    name: siteConfig.name,
    alternateName: 'Aerocity Escort Service Escort Service in Gurgaon Gurugram',
