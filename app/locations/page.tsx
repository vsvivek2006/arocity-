...
export const metadata: Metadata = {
  title: 'Gurgaon Escort Service Locations & Hotel Outcall Directory | Aerocity Escort Service India',
  description:
  ...
  keywords: [
    `escort service locations Aerocity New Delhi`,
    `call girl service areas Aerocity New Delhi`,
      ...
      <section className="py-16 md:py-24 bg-charcoal-900 border-b border-charcoal-800 relative overflow-hidden">
        ...
        <div className="container-luxury relative z-10 text-center">
          ...
          <p className="text-charcoal-300 max-w-3xl mx-auto text-base md:text-lg leading-relaxed font-light">
            Aerocity Escort Service India coordinates discreet, verified escort services across all premier residential sectors, corporate hubs, and five-star hospitality districts in Gurgaon, Aerocity, and Delhi NCR. Select your district below for verified VIP escorts with 20 to 30-minute outcall dispatch.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-charcoal-300 leading-relaxed text-sm md:text-base">
                <p>
                  Aerocity Escort Service caters extensively to guests staying at prestigious five-star hotel properties across Gurgaon and Delhi NCR. Our verified models are adept in five-star hotel etiquette, arriving discreetly dressed in tasteful attire suitable for executive lobbies and luxury suites.
                </p>
                <p>
