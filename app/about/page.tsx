            ...
            <div className="lg:col-span-7 space-y-10">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-5 font-serif">
                  Welcome to Aerocity Escort Service –{' '}
                  <span className="text-gold-600">Gurgaon&apos;s Premier Escort Agency</span>
                </h2>
                <p className="text-gray-700 text-lg leading-relaxed mb-4">
                  <strong>Aerocity Escort Service</strong> is Gurgaon&apos;s leading escort agency, offering a curated{' '}
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                  <p>
                    <strong>Aerocity Escort Service</strong> was founded with a singular vision: to elevate the escort service experience in Aerocity by providing a service that is sophisticated, professional, and uncompromising in its commitment to quality and discretion. In an industry often characterised by inconsistency and a lack of professionalism, we saw an opportunity to create something different — an agency that operates with the standards of a luxury hospitality brand.
                  </p>
                  <p>
                    Our journey began with a simple observation: discerning gentlemen in Aerocity deserved an escort service that matched their lifestyle and expectations. The city had become one of India&apos;s most cosmopolitan centres, home to business leaders, entrepreneurs, and global executives. Yet the options for verified, quality escorts were limited. <strong>Aerocity Escort Service</strong> was created to fill this gap.
                  </p>
                  <p>
              ...
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-6 font-serif">
                  Why Choose Aerocity Escort Service for Escort Service in Aerocity?
                </h3>
              ...
              {/* What Makes Aerocity Escort Service Different */}
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#0F172A] mb-4 font-serif">
                  What Makes Aerocity Escort Service Different
                </h3>
                <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                  <p>
                    In a competitive market, <strong>Aerocity Escort Service</strong> stands apart through a combination of factors that together create a service experience unlike any other in Aerocity. Our rigorous verification process ensures that every profile is genuine, giving our clients confidence in their choices.
                  </p>
                  <p>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                  <p>
                    Safety is a priority at <strong>Aerocity Escort Service</strong>, both for our clients and escorts. Our verification process is designed not only to ensure authenticity but also to establish a secure and respectful environment for all parties.
                  </p>
                  <p>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                  ...
                  <p>
                    This cosmopolitan character attracts sophisticated professionals, entrepreneurs, and global travelers who expect exceptional quality. <strong>Aerocity Escort Service</strong> was created to meet this standard, delivering escort services that match the luxury benchmarks of the city itself.
                  </p>
                </div>
              </div>
              ...
              <div className="pt-4">
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  Experience verified escort services with <strong>Aerocity Escort Service</strong>. Explore our{' '}
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24">
              ...
              <div className="rounded-2xl overflow-hidden shadow-2xl border border-neutral-200/80 bg-neutral-900 group">
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image
                    ...
                    alt="Aerocity Escort Service - Luxury Escort Agency Gurgaon"
                    title="Aerocity Escort Service - Luxury Escort Agency Gurgaon"
                    fill
              ...
              <div className="bg-[#FDFBF7] p-6 rounded-2xl border border-gold-200/50 space-y-3">
                <h4 className="text-sm font-bold uppercase tracking-wider text-[#0F172A] flex items-center gap-2">
                  <HeartHandshake className="w-4 h-4 text-gold-600" /> Aerocity Escort Service Commitment
                </h4>
