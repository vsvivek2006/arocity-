...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  const title = `${category.h1Title || `${category.name} in Gurgaon`} | VIP Escorts & Call Girls | Aerocity Escort Service`;
  const description = `${category.shortDescription} Aerocity Escort Service India offers verified ${category.name.toLowerCase()} in Gurgaon & Delhi NCR. 100% confidential 5-star hotel outcalls within 20-30 mins.`;
  ...
  const categoryKeywords = [
    ...
    `${category.name.toLowerCase()} in Aerocity New Delhi`,
    `${category.name.toLowerCase()} call girls`,
    `hire ${category.name.toLowerCase()} Aerocity New Delhi`,
            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                  {category.longDescription && category.longDescription.length > 0 ? (
                    ...
                    <>
                      ...
                      <p>
                        At <strong>Aerocity Escort Service</strong>, we take pride in offering the finest{' '}
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-700 leading-relaxed text-sm md:text-base">
                  At <strong>Aerocity Escort Service</strong>, our {category.name.toLowerCase()} represent the highest standard of elegance, poise, and VIP escort service. We understand that discerning gentlemen and corporate executives require absolute assurance when making a reservation. That is why every profile in this collection undergoes an in-person vetting process to authenticate credentials, appearance, and social etiquette.
                </p>
              ...
              <div className="p-6 bg-[#FDFBF7] rounded-2xl border border-gold-200/60 space-y-4">
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  To ensure complete trust, Aerocity Escort Service adheres to a strict zero-advance policy: you settle the agreed call girl or escort fee directly in person upon arrival. Your personal details, contact number, and booking records are never shared, logged, or retained, guaranteeing complete peace of mind.
                </p>
              </div>
