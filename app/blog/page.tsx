...
export const metadata: Metadata = {
  title: 'Gurgaon Escorts & Call Girls Blog | Aerocity Escort Service India',
  description:
    'Read the official Aerocity Escort Service India blog for insights on VIP call girls, Russian escorts in Gurgaon, five-star hotel guides, escort girls etiquette, and luxury nightlife.',
  keywords: [
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-br from-[#050508] via-[#0C0B14] to-[#141022] overflow-hidden">
        ...
        <div className="container-luxury relative z-10 text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Authoritative insights on luxury escort services in Gurgaon, five-star hotel outcall etiquette, nightlife recommendations, and verified call girls booking advice from Aerocity Escort Service India.
          </p>
        ...
        <div className="container-luxury max-w-4xl">
          <div className="prose-luxury bg-white p-8 md:p-12 rounded-2xl border border-gold-200/60 shadow-sm">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6 font-serif">
              About the Aerocity Escort Service Editorial Desk
            </h2>
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
              <p>
                The <strong>Aerocity Escort Service</strong> editorial team publishes practical guides on navigating luxury escort services, premium hospitality, and executive nightlife across Gurgaon and the greater NCR region.
              </p>
              <p>
